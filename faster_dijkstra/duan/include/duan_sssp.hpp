/**
 * Top-level SSSP interface for duanalgorithm
 *
 ...
 */
struct SSSPResult {
    vector<long double> dist;  // Shortest distances from source
    vector<int> pred;          // Predecessor in shortest path tree
    DuanStats stats;           // Performance statistics
};
...
public:
     ...
     * @return SSSPResult containing distances and predecessors
     */
